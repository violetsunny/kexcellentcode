...
import top.kexcellent.back.code.handlers.order.handle.pc.PCTransformHandle;
 ...
 */
@Service("transformHandlerProcess")
public class TransformHandlerProcess implements IHandlerProcess {
    ...
    public <T, E> void exec(HandleMessage<T, E> msg) throws Exception {
        ...
        IHandler appIHandler = factorStrategy.createHandler(PCTransformHandle.class);
